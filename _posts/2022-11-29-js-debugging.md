...
- Your end-of-phase presentation video is due at the end of the day on Thursday, December 1. Submit the link to this video using this [form](https://forms.gle/JzaEcUYqr6Sm4yQu8)
...
Each of you will record a screencast on either myTunes, Customer Database, Calculator, Parking, or Memory. The video should be 4-5 minutes long, and no longer. You should choose a piece of the code to walk through and explain using the concepts we covered during Phase 1. You might choose:
...
- [notes on debugging in JS](https://github.com/Momentum-Team-16/notes/blob/main/js-debugging.md)
